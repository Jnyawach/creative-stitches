...
<Head>
    <title>Add Review for {{product.data.name}}</title>
</Head>
        ...
        <div class="mt-5">
            <div class="grid sm:grid-cols-6 gap-4">
                <div class=" sm:col-span-2">
                    <img :src="product.data.mainImage.thumb" :alt="product.data.name" class="rounded-lg">
                </div>
                <div class="sm:col-span-4">
                    <h6 class="font-bold text-2xl">{{ product.data.name }}</h6>
                    <p><span class="mr-2 text-teal-700">Sku:</span>{{product.data.sku}}</p>
                    <div class="mt-3">
                        <form @submit.prevent="form.post(route('reviews.store'))">
