<template layout>
    ...
    <div class="h-screen grid place-content-center">
        <div class="bg-white rounded-3xl shadow overflow-hidden w-96">
            <div class=" py-5 px-5 ">
                <h1 class="font-semibold text-xl text-center mt-5">Login</h1>
            </div>
            <div class="py-5 px-5">
                <form @submit.prevent="form.post(route('admin.authenticate'))">
                    <div class="mt-3">
                        <label for="form-input" class="creative-label"><span class="mr-2 text-teal-700"><i class="fal fa-envelope"></i></span>Email:</label>
                    ...
                    <div class="mt-7">
                        <label for="password" class="creative-label"><span class="mr-2 text-teal-700"><i class="fal fa-lock"></i></span>Password:</label>
                    ...
                    <div class="flex">
                        <p class="font-medium">
                            <Link href="/admin/auth/password-reset" title="Password Reset" class="hover:text-sky-800">Forgot password</Link> |
                            <Link :href="route('admin.register')" title="Register" class="hover:text-sky-800">Register</Link>
                        </p>
...
let submit=()=>{
    form.post('/admin/auth/authenticate');
}
