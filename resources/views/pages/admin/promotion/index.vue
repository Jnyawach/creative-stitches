...
<admin>
    ...
    <title-block>
        <h6 class="font-bold text-sm">Available Promotions</h6>
        <template #info >
                        ...
                        <div class="shadow w-36">
                            <ul class="divide-y">
                                <li class="hover:bg-gray-100 py-2">
                                    <Link :href="route('promotion.show',promotion.id)" class="flex gap-1 text-sm font-bold p-2 w-full h-full text-start">
                                ...
                                <li class="hover:bg-gray-100 py-2">
                                    <Link :href="route('promotion.edit',promotion.id)" class="flex gap-1 text-sm font-bold p-2 w-full h-full text-start" >
                                ...
                                <li class="hover:bg-gray-100">
                                    <Link :href="route('promotion.destroy',promotion.id)" class="flex gap-1 text-red-700 text-sm font-bold p-2 w-full h-full text-start"  method="delete" as="button">
    ...
    <template #sidebar>
        <Link :href="route('promotion.create')" class="flex gap-1 font-semibold">
            <svg class="h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M432 256C432 264.8 424.8 272 416 272h-176V448c0 8.844-7.156 16.01-16 16.01S208 456.8 208 448V272H32c-8.844 0-16-7.15-16-15.99C16 247.2 23.16 240 32 240h176V64c0-8.844 7.156-15.99 16-15.99S240 55.16 240 64v176H416C424.8 240 432 247.2 432 256z"/></svg>
