...
<admin>
    ...
    <div class="">
                        ...
                        <div class="shadow w-36">
                            <ul class="divide-y">
                                <li class="hover:bg-gray-100 h-8">
                                    <Link :href="route('categories.show',category.slug)" class="flex gap-1 text-sm font-bold btn-link  pt-2  text-start">
                                ...
                                <li class="hover:bg-gray-100 h-8">
                                    ...
                                    <Link :href="route('categories.edit',category.id)" class="flex gap-1 text-sm font-bold btn-link pt-2 text-start">
                                ...
                                <li class="hover:bg-gray-100 ">
                                    <Link :href="route('categories.destroy',category.id)" class="flex gap-1 text-red-700 text-sm font-bold p-2 w-full h-full text-start"  method="delete" as="button">
        ...
        <indirect-pagination :data="categories"></indirect-pagination>
    </div>

    <template #sidebar>
        <sidelink :link="route('categories.create')" >
            <button class="flex gap-1 btn-primary btn-small m-1">
