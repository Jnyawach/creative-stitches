...
<admin>
    ...
    <title-block>
        ...
        <template #info >
            <p class="text-sm flex gap-2">
                ...
                <span>Creative Stitches Policy: Terms and Policies</span>
            </p>
    ...
    <div class="mt-10 px-3">
        <div class="border rounded-xl p-2 mt-3" v-for="term in terms" :key="term.id">
                ...
                <div class="flex">
                    <Link :href="route('terms.edit',term.id)" class="flex gap-1 text-teal-700 text-sm font-bold p-2 text-start" >
                    ...
                    <Link :href="route('terms.show',term.id)" class="flex gap-1 text-teal-700 text-sm font-bold p-2 text-start">
                    ...
                    <Link :href="route('terms.destroy',term.id)" class="flex gap-1 text-red-700 text-sm font-bold p-2 text-start"  method="delete" as="button">
    ...
    <template #sidebar>
        <Link :href="route('terms.create')" class="flex gap-1">
            <svg class="h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M432 256C432 264.8 424.8 272 416 272h-176V448c0 8.844-7.156 16.01-16 16.01S208 456.8 208 448V272H32c-8.844 0-16-7.15-16-15.99C16 247.2 23.16 240 32 240h176V64c0-8.844 7.156-15.99 16-15.99S240 55.16 240 64v176H416C424.8 240 432 247.2 432 256z"/></svg>
            <span>Create Terms & Policy</span>
