<template>
    <admin>
        ...
        <title-block>
            ...
            <template #info>
                <p class="text-sm flex gap-2">
                    ...
                    <span>Adjusting permissions will affect user access level</span>
                </p>
        ...
        <div class="">
                            ...
                            <div class="shadow w-36">
                                <ul class="divide-y">
                                    <li class="hover:bg-gray-100 ">
                                        <Link :href="route('permissions.destroy',permission.id)" class="flex gap-1 text-red-700 text-sm font-bold p-2 w-full h-full text-start"  method="delete" as="button">
                                    ...
                                    <li class="hover:bg-gray-100">
                                        <button class="p-2 w-full h-full text-start flex gap-1" @click="editRole(permission)">
            ...
            <indirect-pagination :data="permissions"></indirect-pagination>
        </div>
