    ...
    <title-block>
        ...
        <template #info >
            <p class="text-sm flex gap-2">
                ...
                <span>Running Email Subscriptions</span>
            </p>
        </template>
    </title-block>
    <div class="my-10">
        ...
        <table class="table-auto w-full mt-3 border-t">
            ...
            <tr class="border-b"  v-for="subscription in subscriptions.data" :key="subscription.id">
                ...
                <td class="py-2 px-4">
                    <Link :href="route('subscriptions.destroy',subscription.id)" class="flex gap-1 text-red-700 text-sm font-bold p-1 w-full h-full text-start"  method="delete" as="button">
