    ...
    <title-block>
        ...
        <template #info>
            <p class="text-sm flex gap-2">
                ...
                <span>FAQS are classifies based on these categories</span>
            </p>
                        ...
                        <div class="shadow w-36">
                            <ul class="divide-y">
                                <li class="hover:bg-gray-100 ">
                                    <Link :href="route('faqs-category.destroy',category.id)" class="flex gap-1 text-red-700 text-sm font-bold p-2 w-full h-full text-start"  method="delete" as="button">
                                ...
                                <li class="hover:bg-gray-100">
                                    <button class="p-2 w-full h-full text-start flex gap-1" @click="editCategory(category)">
