            ...
            <div class="w-full my-8 px-3">
                <form class="w-full" @submit.prevent="submit">
                    ...
                    <div class="mt-10 flex justify-center w-full">
                        <button type="submit" :disabled="create.processing" class="py-3 w-1/2  px-10 bg-teal-700 rounded-full text-white font-semibold">
                            Register <span v-if="create.processing" class="animate-ping ml-2"><i class="far fa-ellipsis-h"></i></span></button>
                    </div>
