<template>
    ...
    <section class="flex items-center place-content-center min-h-screen bg-gray-50">
        <div  class="mt-2 px-3 shadow-lg rounded-xl self-center md:w-1/2 lg:w-2/5 p-5 bg-white">
            <div>
                <div class="font-bold text-black-100 text-xl text-center my-3">
                    ...
                    <form class="w-full" @submit.prevent="submit">
                        ...
                        <div class="flex justify-center mt-5">
                            <p class="cursor-pointer font-bold">
                                <Link class="hover:text-teal-700" :href="route('register')">Register new account</Link>
                                 |
                                <Link class="hover:text-teal-700" :href="route('request.password')" title="Reset your password">Forgot Password</Link>
                            </p>
                        </div>
