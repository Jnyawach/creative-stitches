        ...
        <div v-for="product in products" :key="product.id">
            ...
            <div class="mt-2 font-semibold text-gray-800 px-2">
               ...
               <p class="font-bold text-black-100 font-montserrat">$ {{Number(product.price).toFixed(2)}}
                ...
                <div class="py-3">
                    <Link preserve-scroll as="button" method="patch" :href="route('cart.update',product.id)" class="text-black-100 py-2 px-2 sm:px-4 border rounded-full
                     border-black-100 text-xs sm:text-sm hover:text-teal-700 hover:border-teal-700 flex gap-3 group">

                        <svg class="h-4 group-hover:fill-teal-700" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M432 256C432 264.8 424.8 272 416 272h-176V448c0 8.844-7.156 16.01-16 16.01S208 456.8 208 448V272H32c-8.844 0-16-7.15-16-15.99C16 247.2 23.16 240 32 240h176V64c0-8.844 7.156-15.99 16-15.99S240 55.16 240 64v176H416C424.8 240 432 247.2 432 256z"/></svg>
